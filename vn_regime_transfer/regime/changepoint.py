...
def detect_changepoints(
    ...
    # Force 'l2' cost — 'rbf' computes O(n²) Gram matrix and is
    # prohibitively slow in an expanding-window setting (hours on 2k+ pts).
    if model == "rbf":
        logger.info("Switching cost model from 'rbf' to 'l2' for performance "
                     "(rbf is O(n²) and too slow for expanding window)")
    cost_model = "l2"
